...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'sine': {'maxval': 1.0, 'name': 'sine', 'clipInput': True, 'minval': -1.0, 'n': 107, 'fieldname': 'sine', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.1}, 'tpParams': {'minThreshold': 10, 'activationThreshold': 12, 'pamLength': 1}, 'clParams': {'alpha': 0.014294962824332577}},
